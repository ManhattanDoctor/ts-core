...
import { IPage, IPaginable, IPagination } from '../../../dto';
import { ApiResponse } from '../../ApiResponse';
import { HttpApiFilterableMapCollection } from './HttpApiFilterableMapCollection';

export abstract class HttpApiPagedMapCollection<U, V> extends HttpApiFilterableMapCollection<U, IPagination<V>> implements IPage {
    // --------------------------------------------------------------------------
    //
    //  Properties
    //
